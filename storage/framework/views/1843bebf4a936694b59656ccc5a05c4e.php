...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
    <div class="container-fluid">
      ...
      <!-- Nội dung navbar -->
      <form action="<?php echo e(route('products.search')); ?>" method="get" class="d-flex me-4 position-relative" style="width: 400px;">
      ...
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end">
            ...
            <a class="dropdown-item" href="<?php echo e(route('order.index' , ['username' => Auth::user()->name])); ?>" style="color: blue !important;">Lịch sử mua hàng</a>
  ...
  <script src="<?php echo e(asset('resources/js/search_suggest.js')); ?>"> </script><?php /**PATH D:\xampp\htdocs\WebShopTech\resources\views/layouts/master.blade.php ENDPATH**/ ?>